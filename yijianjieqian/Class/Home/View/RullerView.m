...
- (void)start {
    ...
    //设置文字的字体大小
    _num_height = cy_fit(11);
    _txtColor = UIColorFromRGB(0xd7d7d7);
    _lineColor = customColorMake(215, 215, 215);
    ...
    if (_rulerDirection == RulerDirectionHorizontal) {
        ...
        if (_rulerFace == RulerFace_up_left) {
            ...
            _short_mark_top = _mark_bottom-_m_height;
            _long_mark_top = _mark_bottom-_h_height;
            _num_top = _long_mark_top-_unitPX*8+cy_fit(5);
            ...
            _short_mark_top = _mark_bottom+_m_height;
            _long_mark_top = _mark_bottom+_h_height;
            _num_top = _long_mark_top-cy_fit(5);
